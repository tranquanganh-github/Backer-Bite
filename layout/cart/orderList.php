<?php
$orderList = !empty($_SESSION['order_list']) ? $_SESSION['order_list'] : [];
?>
<!-- breadcrumb -->
<!-- shopping-cart  -->
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php foreach ($orderList as $item) {
                        $total += $item['subTotal']; ?>
                        <tr>
                            <form id="" action="process.php?id=<?php echo $item['productId']; ?>&action=update" method="post">
                                <td class="tb-img">
                                    <a href="index.php?f=product&file=detail&id=<?php echo $item['productId']; ?>">
